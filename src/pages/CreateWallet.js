...
export default function CreateWallet() {
  ...
  const metamask = (
    <div className='createwallet'>
      ...
      <img src='https://user-images.githubusercontent.com/6874962/114138543-fd7cd600-9937-11eb-9f27-302a28497ad8.png'></img>
      ...
      <p>Now you have MetaMask on your smartphone. By default your Metamask connected to Ethereum network you change to change it to Binance Smartchain in order to transaction the BEP-20 Tokens. Follow our Next tutorial on how to <a>Change network to Binance Smart chain</a></p>
    </div>
  )
